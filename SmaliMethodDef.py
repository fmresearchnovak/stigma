...
def tests():
    ...
    assert(res_map == soln_map)
    res_map = SmaliMethodDef._update_mt_hashmap_frl(res_map, "    return-void\n")
    assert(res_map == soln_map)
