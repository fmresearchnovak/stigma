...
def main():
    ...
    #sget
    Instrumenter.sign_up("sget", SGET_instrumentation, 1)
    Instrumenter.sign_up("sget-wide", SGET_instrumentation, 1)
    Instrumenter.sign_up("sget-object", SGET_instrumentation, 1)
    Instrumenter.sign_up("sget-boolean", SGET_instrumentation, 1)
    Instrumenter.sign_up("sget-byte", SGET_instrumentation, 1)
    Instrumenter.sign_up("sget-char", SGET_instrumentation, 1)
    Instrumenter.sign_up("sget-short", SGET_instrumentation, 1)

    #sput
    Instrumenter.sign_up("sput", SPUT_instrumentation, 1)
    Instrumenter.sign_up("sput-wide", SPUT_instrumentation, 1)
    Instrumenter.sign_up("sput-object", SPUT_instrumentation, 1)
    Instrumenter.sign_up("sput-boolean", SPUT_instrumentation, 1)
    Instrumenter.sign_up("sput-byte", SPUT_instrumentation, 1)
    Instrumenter.sign_up("sput-char", SPUT_instrumentation, 1)
    Instrumenter.sign_up("sput-short", SPUT_instrumentation, 1)
    
    #iget
    Instrumenter.sign_up("iget", IGET_instrumentation, 1)
    Instrumenter.sign_up("iget-quick", IGET_instrumentation, 1)
    Instrumenter.sign_up("iget-wide-quick", IGET_instrumentation, 1)
    Instrumenter.sign_up("iget-object-quick", IGET_instrumentation, 1)
    Instrumenter.sign_up("iget-wide", IGET_instrumentation, 1)
    Instrumenter.sign_up("iget-object", IGET_instrumentation, 1)
    Instrumenter.sign_up("iget-boolean", IGET_instrumentation, 1)
    Instrumenter.sign_up("iget-byte", IGET_instrumentation, 1)
    Instrumenter.sign_up("iget-char", IGET_instrumentation, 1)
    Instrumenter.sign_up("iget-short", IGET_instrumentation, 1)

    #iput
    Instrumenter.sign_up("iput", IPUT_instrumentation, 1)
    Instrumenter.sign_up("iput-quick", IPUT_instrumentation, 1)
    Instrumenter.sign_up("iput-wide-quick", IPUT_instrumentation, 1)
    Instrumenter.sign_up("iput-object-quick", IPUT_instrumentation, 1)
    Instrumenter.sign_up("iput-wide", IPUT_instrumentation, 1)
    Instrumenter.sign_up("iput-object", IPUT_instrumentation, 1)
    Instrumenter.sign_up("iput-boolean", IPUT_instrumentation, 1)
    Instrumenter.sign_up("iput-byte", IPUT_instrumentation, 1)
    Instrumenter.sign_up("iput-char", IPUT_instrumentation, 1)
    Instrumenter.sign_up("iput-short", IPUT_instrumentation, 1)

    #aget
    Instrumenter.sign_up("aget", AGET_instrumentation, 1)
    Instrumenter.sign_up("aget-wide", AGET_instrumentation, 1)
    Instrumenter.sign_up("aget-object", AGET_instrumentation, 1)
    Instrumenter.sign_up("aget-boolean", AGET_instrumentation, 1)
    Instrumenter.sign_up("aget-byte", AGET_instrumentation, 1)
    Instrumenter.sign_up("aget-char", AGET_instrumentation, 1)
    Instrumenter.sign_up("aget-short", AGET_instrumentation, 1)

    #aput
    Instrumenter.sign_up("aput", APUT_instrumentation, 1)
    Instrumenter.sign_up("aput-wide", APUT_instrumentation, 1)
    Instrumenter.sign_up("aput-object", APUT_instrumentation, 1)
    Instrumenter.sign_up("aput-boolean", APUT_instrumentation, 1)
    Instrumenter.sign_up("aput-byte", APUT_instrumentation, 1)
    Instrumenter.sign_up("aput-char", APUT_instrumentation, 1)
    Instrumenter.sign_up("aput-short", APUT_instrumentation, 1)

    #other array related
    Instrumenter.sign_up("new-array", NEW_ARRAY_instrumentation, 1)
    Instrumenter.sign_up("array-length", ARRAY_LENGTH_instrumentation, 1)
    Instrumenter.sign_up("filled-new-array", FILLED_NEW_ARRAY_instrumentation, 2)
    Instrumenter.sign_up("filled-new-array/range", FILLED_NEW_ARRAY_instrumentation, 2)

    #return 
    Instrumenter.sign_up("return", RETURN_instrumentation, 1)
    Instrumenter.sign_up("return-wide", RETURN_instrumentation, 1)
    Instrumenter.sign_up("return-object", RETURN_instrumentation, 1)

    #move 
    Instrumenter.sign_up("move", MOVE_instrumentation, 1)
    Instrumenter.sign_up("move/from16", MOVE_instrumentation, 1)
    Instrumenter.sign_up("move/16", MOVE_instrumentation, 1)
    Instrumenter.sign_up("move-wide", MOVE_instrumentation, 1)
    Instrumenter.sign_up("move-wide/from16", MOVE_instrumentation, 1)
    Instrumenter.sign_up("move-wide/16", MOVE_instrumentation, 1)
    Instrumenter.sign_up("move-object", MOVE_instrumentation, 1)
    Instrumenter.sign_up("move-object/from16", MOVE_instrumentation, 1)
    Instrumenter.sign_up("move-object/16", MOVE_instrumentation, 1)
    
    #const 
    Instrumenter.sign_up("const", CONST_instrumentation, 1)
    Instrumenter.sign_up("const/4", CONST_instrumentation, 1)
    Instrumenter.sign_up("const/16", CONST_instrumentation, 1)
    Instrumenter.sign_up("const/high16", CONST_instrumentation, 1)
    Instrumenter.sign_up("const-wide", CONST_instrumentation, 1)
    Instrumenter.sign_up("const-wide/16", CONST_instrumentation, 1)
    Instrumenter.sign_up("const-wide/32", CONST_instrumentation, 1)
    Instrumenter.sign_up("const-wide/high16", CONST_instrumentation, 1)
    Instrumenter.sign_up("const-class", CONST_instrumentation, 1)
    Instrumenter.sign_up("const-string-jumbo", CONST_instrumentation, 1)
    Instrumenter.sign_up("const-string", CONST_instrumentation, 1)
    
    #new-instance
    Instrumenter.sign_up("new-instance", NEW_INSTANCE_instrumentation, 1)

    #binaryop int
    Instrumenter.sign_up("add-int", BINARYOP_instrumenter, 2)
    Instrumenter.sign_up("add-int/2addr", BINARYOP_instrumenter, 2)
    Instrumenter.sign_up("add-int/lit16", BINARYOP_instrumenter, 2)
    Instrumenter.sign_up("add-int/lit8", BINARYOP_instrumenter, 2)

    Instrumenter.sign_up("sub-int", BINARYOP_instrumenter, 2)
    Instrumenter.sign_up("sub-int/2addr", BINARYOP_instrumenter, 2)
    Instrumenter.sign_up("sub-int/lit16", BINARYOP_instrumenter, 2)
    Instrumenter.sign_up("sub-int/lit8", BINARYOP_instrumenter, 2)
    
    Instrumenter.sign_up("mul-int", BINARYOP_instrumenter, 2)
    Instrumenter.sign_up("mul-int/2addr", BINARYOP_instrumenter, 2)
    Instrumenter.sign_up("mul-int/lit16", BINARYOP_instrumenter, 2)
    Instrumenter.sign_up("mul-int/lit8", BINARYOP_instrumenter, 2)
    
    Instrumenter.sign_up("div-int", BINARYOP_instrumenter, 2)
    Instrumenter.sign_up("div-int/2addr", BINARYOP_instrumenter, 2)
    Instrumenter.sign_up("div-int/lit16", BINARYOP_instrumenter, 2)
    Instrumenter.sign_up("div-int/lit8", BINARYOP_instrumenter, 2)
    
    #binaryop long
    Instrumenter.sign_up("add-long", BINARYOP_instrumenter, 2)
    Instrumenter.sign_up("add-long/2addr", BINARYOP_instrumenter, 2)
        
    Instrumenter.sign_up("sub-long", BINARYOP_instrumenter, 2)
    Instrumenter.sign_up("sub-long/2addr", BINARYOP_instrumenter, 2)

    Instrumenter.sign_up("mul-long", BINARYOP_instrumenter, 2)
    Instrumenter.sign_up("mul-long/2addr", BINARYOP_instrumenter, 2)

    Instrumenter.sign_up("div-long", BINARYOP_instrumenter, 2)
    Instrumenter.sign_up("div-long/2addr", BINARYOP_instrumenter, 2)

    
    #binaryop float
    Instrumenter.sign_up("add-float", BINARYOP_instrumenter, 2)
    Instrumenter.sign_up("add-float/2addr", BINARYOP_instrumenter, 2)

    Instrumenter.sign_up("sub-float", BINARYOP_instrumenter, 2)
    Instrumenter.sign_up("sub-float/2addr", BINARYOP_instrumenter, 2)

    Instrumenter.sign_up("mul-float", BINARYOP_instrumenter, 2)
    Instrumenter.sign_up("mul-float/2addr", BINARYOP_instrumenter, 2)

    Instrumenter.sign_up("div-float", BINARYOP_instrumenter, 2)
    Instrumenter.sign_up("div-float/2addr", BINARYOP_instrumenter, 2)

    #binaryop double
    Instrumenter.sign_up("add-double", BINARYOP_instrumenter, 2)
    Instrumenter.sign_up("add-double/2addr", BINARYOP_instrumenter, 2)

    Instrumenter.sign_up("sub-double", BINARYOP_instrumenter, 2)
    Instrumenter.sign_up("sub-double/2addr", BINARYOP_instrumenter, 2)
    
    Instrumenter.sign_up("mul-double", BINARYOP_instrumenter, 2)
    Instrumenter.sign_up("mul-double/2addr", BINARYOP_instrumenter, 2)
    
    Instrumenter.sign_up("div-double", BINARYOP_instrumenter, 2)
    Instrumenter.sign_up("div-double/2addr", BINARYOP_instrumenter, 2)
    
    #invoke-
    Instrumenter.sign_up("invoke-virtual", INVOKE_instrumentation, 2, True)
    Instrumenter.sign_up("invoke-super", INVOKE_instrumentation, 2, True)
    Instrumenter.sign_up("invoke-direct", INVOKE_instrumentation, 2, True)
    Instrumenter.sign_up("invoke-static", INVOKE_instrumentation, 2, True)
    Instrumenter.sign_up("invoke-interface", INVOKE_instrumentation, 2, True)
    Instrumenter.sign_up("invoke-virtual/range", INVOKE_instrumentation, 2, True)
    Instrumenter.sign_up("invoke-super/range", INVOKE_instrumentation, 2, True)
    Instrumenter.sign_up("invoke-direct/range", INVOKE_instrumentation, 2, True)
    Instrumenter.sign_up("invoke-static/range", INVOKE_instrumentation, 2, True)
    Instrumenter.sign_up("invoke-interface/range", INVOKE_instrumentation, 2, True)
    ...
    for opcode in CONVERTER_INSTRUCTION_LIST:
        Instrumenter.sign_up(opcode, CONVERTER_instrumentation, 2)
        
    
    
    #if and cmp
    Instrumenter.sign_up("if-eq", IF_instrumentation, 4)
    Instrumenter.sign_up("if-ne", IF_instrumentation, 4)
    Instrumenter.sign_up("if-lt", IF_instrumentation, 4)
    Instrumenter.sign_up("if-ge", IF_instrumentation, 4)
    Instrumenter.sign_up("if-gt", IF_instrumentation, 4)
    Instrumenter.sign_up("if-le", IF_instrumentation, 4)
    Instrumenter.sign_up("if-eqz", IF_instrumentation, 4)
    Instrumenter.sign_up("if-nez", IF_instrumentation, 4)
    Instrumenter.sign_up("if-ltz", IF_instrumentation, 4)
    Instrumenter.sign_up("if-gez", IF_instrumentation, 4)
    Instrumenter.sign_up("if-gtz", IF_instrumentation, 4)
    Instrumenter.sign_up("if-lez", IF_instrumentation, 4)
    Instrumenter.sign_up("cmpl-float", IF_instrumentation, 4)
    Instrumenter.sign_up("cmpl-double", IF_instrumentation, 4)
    Instrumenter.sign_up("cmpg-double", IF_instrumentation, 4)
    Instrumenter.sign_up("cmpg-float", IF_instrumentation, 4)
    Instrumenter.sign_up("cmp-long", IF_instrumentation, 4)
