'''
 ...
 UPPERCASE is used for instructions that are actual opcodes (and also comments and jump target labels).
 _Camel_Case is used for "abstract" and "attribute" classes that should not be instantiated directly.  They have no __init__() constructor method.
'''
...
# Should the new class be a child of __Single_Dest_Register_instruction?
#   * Note: __Single_Dest_Register_instruction is any instruction that
...
class _Implicit_Registers_Attribute():
...
class _Implicit_First_Register_Attribute():
...
class _ThirtyTwoBit_Parameters_Attribute():
...
class _Object_Parameters_Attribute():
    '''instruction classes that extend this type
    are those in which ALL the registers/parameters
    are object types
    '''
...
class _SixtyFourBit_Dest_Attribute():
    '''instruction classes that extend this type
    are those in which ALL the registers/parameters
...
# invoke instructions
class _Invoke_Instruction(SmaliAssemblyInstruction):
    def get_slicing_action(self, tracked):
...
# jump instructions
class _Jump_To_Label_Instruction(SmaliAssemblyInstruction):
    def get_slicing_action(self, tracked):
...
class MOVE(_ThirtyTwoBit_Parameters_Attribute, SmaliAssemblyInstruction, Second_Reg_To_First_Reg):
    ''' move v6, p2 '''
...
# but "-" is not a valid character in a class name
class MOVE_WIDE(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, MOVE):
    '''move-wide v2, v4'''
    def opcode(self):
        return "move-wide"
...
class MOVE_OBJECT(_Object_Parameters_Attribute, MOVE):
    '''move-object v3, v5'''
    def opcode(self):
        return "move-object"
...
class _Single_Register_Instruction(SmaliAssemblyInstruction):
    '''A instruction classess that extend this type are those
    that have a single register as a parameter.
    '''
...
class _Single_Dest_Register_Instruction(SmaliAssemblyInstruction):
    ''' Classes that extend this type are those that
    have only ONE parameter that recieves a value; a register that serves as a destination.
    '''
...
class MOVE_RESULT(_ThirtyTwoBit_Parameters_Attribute, _Single_Register_Instruction):
    def opcode(self):
        return "move-result"

class MOVE_RESULT_WIDE(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Single_Register_Instruction):
    def opcode(self):
        return "move-result-wide"

class MOVE_RESULT_OBJECT(_Object_Parameters_Attribute, _Single_Register_Instruction):
    def opcode(self):
        return "move-result-object"

class MOVE_EXCEPTION(_Object_Parameters_Attribute, _Single_Register_Instruction):
    def opcode(self):
...
class RETURN(_ThirtyTwoBit_Parameters_Attribute, _Single_Register_Instruction):
    def opcode(self):
        return "return"

class RETURN_WIDE(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Single_Register_Instruction):
    def opcode(self):
        return "return-wide"

class RETURN_OBJECT(_Object_Parameters_Attribute, _Single_Register_Instruction):
    def opcode(self):
        return "return-object"



class CONST(_ThirtyTwoBit_Parameters_Attribute, _Single_Dest_Register_Instruction, First_Reg_Dead_End):
...
class CONST_WIDE(_Implicit_Registers_Attribute, _SixtyFourBit_Dest_Attribute, CONST):
    def opcode(self):
        return "const-wide"
...
class CONST_CLASS(_Object_Parameters_Attribute, _Single_Dest_Register_Instruction):
...
class CHECK_CAST( _Object_Parameters_Attribute, _Single_Dest_Register_Instruction, No_Slicing_Actions): 
    def opcode(self):
        return "check-cast"
...
class _Parameter_List_Instruction(SmaliAssemblyInstruction):
    ''' Classes that extend this type are those that
    have a list of registers as parameters.  All registers are explicitly listed.
    Example: invoke-virtual {v0, v1, v2, v3, v4}, Lcom/example/MyClass;->myMethod(Ljava/lang/String;ID)V
    '''
...
class GOTO(_Jump_To_Label_Instruction):
...
class CMPL_FLOAT( _ThirtyTwoBit_Parameters_Attribute, _Triple_Register_Instruction, First_Reg_Dead_End):
    def opcode(self):
        return "cmpl-float"
        
class CMPG_FLOAT(_ThirtyTwoBit_Parameters_Attribute, _Triple_Register_Instruction, First_Reg_Dead_End):
    def opcode(self):
        return "cmpg-float"
...
class _Two_Register_Comparison_Instruction(_Jump_To_Label_Instruction):
    ''' Classes that inherit this type or those that
    make a comparison between two register values and the (possibly) jump to a target label.
    '''
...
class IF_EQ(_Two_Register_Comparison_Instruction):
    def opcode(self):
        return "if-eq"
        
class IF_NE(_Two_Register_Comparison_Instruction):
    def opcode(self):
        return "if-ne"
        
class IF_LT(_Two_Register_Comparison_Instruction):
    def opcode(self):
        return "if-lt"
        
class IF_GE(_Two_Register_Comparison_Instruction):
    def opcode(self):
        return "if-ge"
        
class IF_GT(_Two_Register_Comparison_Instruction):
    def opcode(self):
        return "if-gt"
        
class IF_LE(_Two_Register_Comparison_Instruction):
    def opcode(self):
        return "if-le"
        
        
class _One_Register_Comparison_Instruction(_Jump_To_Label_Instruction):
    ''' Classes that inherit this type or those that
    make a comparison between a single register value and then (possibly) jump to a target label.'''
...
class IF_EQZ(_One_Register_Comparison_Instruction):
    def opcode(self):
        return "if-eqz"
        
class IF_NEZ(_One_Register_Comparison_Instruction):
    def opcode(self):
        return "if-nez"

class IF_LTZ(_One_Register_Comparison_Instruction):
    def opcode(self):
        return "if-ltz"
        
class IF_GEZ(_One_Register_Comparison_Instruction):
    def opcode(self):
        return "if-gez"
        
class IF_GTZ(_One_Register_Comparison_Instruction):
    def opcode(self):
        return "if-gtz"
        
class IF_LEZ(_One_Register_Comparison_Instruction):
    def opcode(self):
        return "if-lez"     
...
class AGET_WIDE(_Array_Parameters_Type_Pattern, _Implicit_First_Register_Attribute, _Triple_Register_Instruction):
    def opcode(self):
        return "aget-wide"
...
class APUT_WIDE(_Array_Parameters_Type_Pattern, _Implicit_First_Register_Attribute, _Triple_Register_Instruction, First_Reg_To_Third_Reg):
    def opcode(self):
        return "aput-wide"
...
class _I_Instruction(SmaliAssemblyInstruction):
    ''' Classes that extend this type are those that
    involve instance fields such as iget, iput, etc.
    '''
    # A parent class that should never be instantiated directly
...
class IGET_WIDE(_Implicit_First_Register_Attribute, _I_Instruction, Third_Var_To_First_Reg):
    def opcode(self):
        return "iget-wide"
...
class IPUT_WIDE(_Implicit_First_Register_Attribute, _I_Instruction, First_Reg_To_Third_Var):
    def opcode(self):
        return "iput-wide"
...
class _S_Instruction(SmaliAssemblyInstruction):
    ''' Classes that extend this type are those that
    involve static fields such as sget, sput, etc.
    '''
...
class SGET_WIDE(_Implicit_Registers_Attribute, _S_Instruction, Third_Var_To_First_Reg):
    def opcode(self):
        return "sget-wide"
...
class SPUT_WIDE(_Implicit_Registers_Attribute, _S_Instruction, First_Reg_To_Third_Var):
    def opcode(self):
        return "sput-wide"
...
class _Two_Register_Unary_Instruction(SmaliAssemblyInstruction, Second_Reg_To_First_Reg_Arith):
    ''' Classes that extend this type are those that
    take two registers as parameters and perform a unary operation.  For example, convering a value
    stored in one register and storing the result in another register like double-to-int v0, v1
    '''
    # A parent class that should never be instantiated directly
...
class NEG_INT(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_Unary_Instruction, Second_Reg_To_First_Reg_Arith):
    def opcode(self):
        return "neg-int"

class NOT_INT(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_Unary_Instruction, Second_Reg_To_First_Reg_Arith):
    def opcode(self):
        return "not-int"
        
class NOT_LONG(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Two_Register_Unary_Instruction, Second_Reg_To_First_Reg_Arith):
    def opcode(self):
        return "neg-long"

class NEG_LONG(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Two_Register_Unary_Instruction, Second_Reg_To_First_Reg_Arith):
    def opcode(self):
        return "neg-long"

class NEG_FLOAT(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_Unary_Instruction, Second_Reg_To_First_Reg_Arith):
    def opcode(self):
        return "neg-float"

class NEG_DOUBLE(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Two_Register_Unary_Instruction, Second_Reg_To_First_Reg_Arith):
    def opcode(self):
        return "neg-double"

class INT_TO_LONG(_Implicit_First_Register_Attribute, _Two_Register_Unary_Instruction):
    def opcode(self):
        return "int-to-long"
...
class INT_TO_FLOAT(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_Unary_Instruction):
    def opcode(self):
        return "int-to-float"

class INT_TO_DOUBLE(_Implicit_First_Register_Attribute, _Two_Register_Unary_Instruction):
    def opcode(self):
...
class LONG_TO_DOUBLE(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Two_Register_Unary_Instruction):
    def opcode(self):
        return "long-to-double"


class FLOAT_TO_INT(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_Unary_Instruction):
    def opcode(self):
        return "float-to-int"

class FLOAT_TO_LONG(_Implicit_First_Register_Attribute, _Two_Register_Unary_Instruction):
    def opcode(self):
...
class FLOAT_TO_DOUBLE(_Implicit_First_Register_Attribute, _Two_Register_Unary_Instruction):
    def opcode(self):
...
class DOUBLE_TO_LONG(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Two_Register_Unary_Instruction):
    def opcode(self):
...
class INT_TO_BYTE(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_Unary_Instruction):
    def opcode(self):
        return "int-to-byte"

class INT_TO_CHAR(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_Unary_Instruction):
    def opcode(self):
        return "int-to-char"

class INT_TO_SHORT(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_Unary_Instruction):
    def opcode(self):
        return "int-to-short"

class ADD_INT(_ThirtyTwoBit_Parameters_Attribute, _Triple_Register_Instruction, Second_Reg_To_First_Reg_Arith):
    def opcode(self):
        return "add-int"

class SUB_INT(_ThirtyTwoBit_Parameters_Attribute, _Triple_Register_Instruction, Second_Reg_To_First_Reg_Arith):
    def opcode(self):
        return "sub-int"

class MUL_INT(_ThirtyTwoBit_Parameters_Attribute, _Triple_Register_Instruction, Second_Reg_To_First_Reg_Arith):
    def opcode(self):
        return "mul-int"

class DIV_INT(_ThirtyTwoBit_Parameters_Attribute, _Triple_Register_Instruction, Second_Reg_To_First_Reg_Arith):
    def opcode(self):
        return "div-int"

class REM_INT(_ThirtyTwoBit_Parameters_Attribute, _Triple_Register_Instruction, Second_Reg_To_First_Reg_Arith):
    def opcode(self):
        return "rem-int"

class AND_INT(_ThirtyTwoBit_Parameters_Attribute, _Triple_Register_Instruction, Second_Reg_To_First_Reg_Arith):
    def opcode(self):
        return "and-int"

class OR_INT(_ThirtyTwoBit_Parameters_Attribute, _Triple_Register_Instruction, Second_Reg_To_First_Reg_Arith):
    def opcode(self):
        return "or-int"

class XOR_INT(_ThirtyTwoBit_Parameters_Attribute, _Triple_Register_Instruction, Second_Reg_To_First_Reg_Arith):
    def opcode(self):
        return "xor-int"

class SHL_INT(_ThirtyTwoBit_Parameters_Attribute, _Triple_Register_Instruction):
    def opcode(self):
        return "shl-int"

class SHR_INT(_ThirtyTwoBit_Parameters_Attribute, _Triple_Register_Instruction):
    def opcode(self):
        return "shr-int"

class USHR_INT(_ThirtyTwoBit_Parameters_Attribute, _Triple_Register_Instruction):
    def opcode(self):
        return "ushr-int"

class ADD_LONG(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Triple_Register_Instruction, Second_Reg_To_First_Reg_Arith):
    def opcode(self):
        return "add-long"

class SUB_LONG(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Triple_Register_Instruction, Second_Reg_To_First_Reg_Arith):
    def opcode(self):
        return "sub-long"

class MUL_LONG(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Triple_Register_Instruction, Second_Reg_To_First_Reg_Arith):
    def opcode(self):
        return "mul-long"

class DIV_LONG(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Triple_Register_Instruction, Second_Reg_To_First_Reg_Arith):
    def opcode(self):
        return "div-long"

class REM_LONG(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Triple_Register_Instruction, Second_Reg_To_First_Reg_Arith):
    def opcode(self):
        return "rem-long"

class AND_LONG(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Triple_Register_Instruction, Second_Reg_To_First_Reg_Arith):
    def opcode(self):
        return "and-long"

class OR_LONG(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Triple_Register_Instruction, Second_Reg_To_First_Reg_Arith):
    def opcode(self):
        return "or-long"

class XOR_LONG(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Triple_Register_Instruction, Second_Reg_To_First_Reg_Arith):
    def opcode(self):
        return "xor-long"

class SHL_LONG(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Triple_Register_Instruction):
    def opcode(self):
        return "shl-long"

class SHR_LONG(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute,_Triple_Register_Instruction):
    def opcode(self):
        return "shr-long"

class USHR_LONG(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Triple_Register_Instruction):
    def opcode(self):
        return "ushr-long"

class ADD_FLOAT(_ThirtyTwoBit_Parameters_Attribute, _Triple_Register_Instruction, Second_Reg_To_First_Reg_Arith):
    def opcode(self):
        return "add-float"

class SUB_FLOAT(_ThirtyTwoBit_Parameters_Attribute, _Triple_Register_Instruction, Second_Reg_To_First_Reg_Arith):
    def opcode(self):
        return "sub-float"

class MUL_FLOAT(_ThirtyTwoBit_Parameters_Attribute, _Triple_Register_Instruction, Second_Reg_To_First_Reg_Arith):
    def opcode(self):
        return "mul-float"

class DIV_FLOAT(_ThirtyTwoBit_Parameters_Attribute, _Triple_Register_Instruction, Second_Reg_To_First_Reg_Arith):
    def opcode(self):
        return "div-float"

class REM_FLOAT(_ThirtyTwoBit_Parameters_Attribute, _Triple_Register_Instruction, Second_Reg_To_First_Reg_Arith):
    def opcode(self):
        return "rem-float"

class ADD_DOUBLE(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Triple_Register_Instruction, Second_Reg_To_First_Reg_Arith):
    def opcode(self):
        return "add-double"

class SUB_DOUBLE(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Triple_Register_Instruction, Second_Reg_To_First_Reg_Arith):
    def opcode(self):
        return "sub-double"

class MUL_DOUBLE(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Triple_Register_Instruction, Second_Reg_To_First_Reg_Arith):
    def opcode(self):
        return "mul-double"

class DIV_DOUBLE(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Triple_Register_Instruction, Second_Reg_To_First_Reg_Arith):
    def opcode(self):
        return "div-double"

class REM_DOUBLE(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Triple_Register_Instruction, Second_Reg_To_First_Reg_Arith):
    def opcode(self):
        return "rem-double"
...
class _Two_Register_Binary_Instruction(SmaliAssemblyInstruction, Second_Reg_To_First_Reg_Arith_2addr):
    ''' Classes that extend this type are those that
    take two registers as parameters and perform a binary operation and store the result into the first register
    overwriting the original value.  For example, add-int/2addr v0, v1 which is equivalent to memory[v0] = memory[v0] + memory[v1]'''
    # A parent class that should never be instantiated directly
...
class ADD_INT_2ADDR(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_Binary_Instruction,):
    def opcode(self):
        return "add-int/2addr"

class SUB_INT_2ADDR(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_Binary_Instruction):
    def opcode(self):
        return "sub-int/2addr"

class MUL_INT_2ADDR(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_Binary_Instruction):
    def opcode(self):
        return "mul-int/2addr"

class DIV_INT_2ADDR(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_Binary_Instruction):
    def opcode(self):
        return "div-int/2addr"
        
class REM_INT_2ADDR(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_Binary_Instruction):
    def opcode(self):
        return "rem-int/2addr"

class AND_INT_2ADDR(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_Binary_Instruction):
    def opcode(self):
        return "and-int/2addr"
        
class OR_INT_2ADDR(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_Binary_Instruction):
    def opcode(self):
        return "or-int/2addr"

class XOR_INT_2ADDR(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_Binary_Instruction):
    def opcode(self):
        return "xor-int/2addr"

class SHL_INT_2ADDR(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_Binary_Instruction):
    def opcode(self):
        return "shl-int/2addr"

class SHR_INT_2ADDR(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_Binary_Instruction):
    def opcode(self):
        return "shr-int/2addr"

class USHR_INT_2ADDR(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_Binary_Instruction):
    def opcode(self):
        return "ushr-int/2addr"
            
class ADD_LONG_2ADDR(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Two_Register_Binary_Instruction):
    def opcode(self):
        return "add-long/2addr"

class SUB_LONG_2ADDR(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Two_Register_Binary_Instruction):
    def opcode(self):
        return "sub-long/2addr"

class MUL_LONG_2ADDR(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Two_Register_Binary_Instruction):
    def opcode(self):
        return "mul-long/2addr"

class DIV_LONG_2ADDR(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Two_Register_Binary_Instruction):
    def opcode(self):
        return "div-long/2addr"
        
class REM_LONG_2ADDR(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Two_Register_Binary_Instruction):
    def opcode(self):
        return "rem-long/2addr"

class AND_LONG_2ADDR(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Two_Register_Binary_Instruction):
    def opcode(self):
        return "and-long/2addr"
        
class OR_LONG_2ADDR(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Two_Register_Binary_Instruction):
    def opcode(self):
        return "or-long/2addr"

class XOR_LONG_2ADDR(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Two_Register_Binary_Instruction):
    def opcode(self):
        return "xor-long/2addr"

class SHL_LONG_2ADDR(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Two_Register_Binary_Instruction):
    def opcode(self):
        return "shl-long/2addr"

class SHR_LONG_2ADDR(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Two_Register_Binary_Instruction):
    def opcode(self):
        return "shr-long/2addr"

class USHR_LONG_2ADDR(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Two_Register_Binary_Instruction):
    def opcode(self):
        return "ushr-long/2addr"

class ADD_FLOAT_2ADDR(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_Binary_Instruction):
    def opcode(self):
        return "add-float/2addr"
        
class SUB_FLOAT_2ADDR(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_Binary_Instruction):
    def opcode(self):
        return "sub-float/2addr"
        
class MUL_FLOAT_2ADDR(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_Binary_Instruction):
    def opcode(self):
        return "mul-float/2addr"
        
class DIV_FLOAT_2ADDR(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_Binary_Instruction):
    def opcode(self):
        return "div-float/2addr"
        
class REM_FLOAT_2ADDR(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_Binary_Instruction):
    def opcode(self):
        return "rem-float/2addr"
        
class ADD_DOUBLE_2ADDR(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Two_Register_Binary_Instruction):
    def opcode(self):
        return "add-double/2addr"
        
class SUB_DOUBLE_2ADDR(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Two_Register_Binary_Instruction):
    def opcode(self):
        return "sub-double/2addr"
        
class MUL_DOUBLE_2ADDR(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Two_Register_Binary_Instruction):
    def opcode(self):
        return "mul-double/2addr"
        
class DIV_DOUBLE_2ADDR(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Two_Register_Binary_Instruction):
    def opcode(self):
        return "div-double/2addr"
        
class REM_DOUBLE_2ADDR(_SixtyFourBit_Dest_Attribute, _Implicit_Registers_Attribute, _Two_Register_Binary_Instruction):
    def opcode(self):
...
class _Two_Register_And_Literal_Binary_Instruction(SmaliAssemblyInstruction, Second_Reg_To_First_Reg_Arith):
    ''' Classes that extend this type are those that
    take two registers and a literal value as parameters and perform a binary operation between the second register and the literal value.
    '''
    # A parent class that should never be instantiated directly
...
class ADD_INT_LIT16(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_And_Literal_Binary_Instruction):
    def opcode(self):
        return "add-int/lit16"
        
class SUB_INT_LIT16(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_And_Literal_Binary_Instruction):
    def opcode(self):
        return "sub-int/lit16"

class MUL_INT_LIT16(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_And_Literal_Binary_Instruction):
    def opcode(self):
        return "mul-int/lit16"
        
class DIV_INT_LIT16(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_And_Literal_Binary_Instruction):
    def opcode(self):
        return "div-int/lit16"
        
class REM_INT_LIT16(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_And_Literal_Binary_Instruction):
    def opcode(self):
        return "rem-int/lit16"

class AND_INT_LIT16(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_And_Literal_Binary_Instruction):
    def opcode(self):
        return "and-int/lit16"

class OR_INT_LIT16(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_And_Literal_Binary_Instruction):
    def opcode(self):
        return "or-int/lit16"
        
class XOR_INT_LIT16(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_And_Literal_Binary_Instruction):
    def opcode(self):
        return "xor-int/lit16"
        
class RSUB_INT(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_And_Literal_Binary_Instruction):
...
class ADD_INT_LIT8(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_And_Literal_Binary_Instruction):
    def opcode(self):
        return "add-int/lit8"
        
class SUB_INT_LIT8(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_And_Literal_Binary_Instruction):
    def opcode(self):
        return "sub-int/lit8"
        
class RSUB_INT_LIT8(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_And_Literal_Binary_Instruction):
    def opcode(self):
        return "rsub-int/lit8"
        
class MUL_INT_LIT8(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_And_Literal_Binary_Instruction):
    def opcode(self):
        return "mul-int/lit8"
        
class DIV_INT_LIT8(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_And_Literal_Binary_Instruction):
    def opcode(self):
        return "div-int/lit8"
        
class REM_INT_LIT8(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_And_Literal_Binary_Instruction):
    def opcode(self):
        return "rem-int/lit8"
        
class AND_INT_LIT8(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_And_Literal_Binary_Instruction):
    def opcode(self):
        return "and-int/lit8"
        
class OR_INT_LIT8(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_And_Literal_Binary_Instruction):
    def opcode(self):
        return "or-int/lit8"
        
class XOR_INT_LIT8(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_And_Literal_Binary_Instruction):
    def opcode(self):
        return "xor-int/lit8"
        
class SHL_INT_LIT8(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_And_Literal_Binary_Instruction):
    def opcode(self):
        return "shl-int/lit8"
        
class SHR_INT_LIT8(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_And_Literal_Binary_Instruction):
    def opcode(self):
        return "shr-int/lit8"
        
class USHR_INT_LIT8(_ThirtyTwoBit_Parameters_Attribute, _Two_Register_And_Literal_Binary_Instruction):
    def opcode(self):
...
class _I_Instruction_Quick(SmaliAssemblyInstruction):
    ''' Classes that extend this type are those that
    have "quick" in their name, such as iget-quick, iput-quick, etc.
    These instructions can sometimes be used to read class instance fields and are faster.'''
    # A parent class that should never be instantiated directly
...
class IGET_WIDE_QUICK(_SixtyFourBit_Dest_Attribute, _Implicit_First_Register_Attribute, _I_Instruction_Quick, Third_Var_To_First_Reg):
    def opcode(self):
        return "iget-wide-quick"
        
class IGET_OBJECT_QUICK(_Object_Parameters_Attribute, _I_Instruction_Quick, Third_Var_To_First_Reg):
    def opcode(self):
...
class IPUT_WIDE_QUICK(_SixtyFourBit_Dest_Attribute, _Implicit_First_Register_Attribute, _I_Instruction_Quick, First_Reg_To_Third_Var):
    def opcode(self):
        return "iput-wide-quick"
        
class IPUT_OBJECT_QUICK(_Object_Parameters_Attribute, _I_Instruction_Quick, First_Reg_To_Third_Var):
    def opcode(self):
...
# TODO: Move this to SmaliTypes.py
