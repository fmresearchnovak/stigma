GENERIC_STORAGE_CLASS_NAME = "stigmacom/stigmastorage/package1/StorageClass"
...
class TaintStorageHandler:
    ...
    def add_taint_location(self, source_class_fqn, method_name, register_name):  
        ...
        method_name = method_name.replace(">", "")
        location_field_name = source_class_fqn + method_name + register_name
...
if __name__ == "__main__":
    ...
    assert(storageHandler2.storage_classes[0].get_storage_class_fqn() == "stigmacom/stigmastorage/package1/StorageClass1")
    assert(storageHandler.storage_classes[1].get_storage_class_fqn() == "stigmacom/stigmastorage/package1/StorageClass2")
    assert(storageHandler.add_taint_location("Example/com/class3", "method3", "v1") == "Lstigmacom/stigmastorage/package1/StorageClass3;->Examplecomclass3method3v1:F")
    assert(storageHandler.get_taint_location_accessor("Example/com/class", "method", "v1") == "Lstigmacom/stigmastorage/package1/StorageClass1;->Examplecomclassmethodv1:F")
