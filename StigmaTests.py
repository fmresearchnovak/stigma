...
def type_safety_checker_control_flow_test_edge_case():
    ...
    new_list = []
    for elm in method_list:
        elm = elm.replace("\n", "")
        new_list.append(elm)

    print("\nRunning tests on edge case 1 for weather app.")
    print("total lines in method: ", len(new_list))
    smd =  SmaliMethodDef.SmaliMethodDef(new_list, None)
    print("size of the type map: ", len(smd.tsc.method_type_list))
    print("Looks like it didnt crash!, congragulations!!!")
...
def type_safety_checker_control_flow_test_edge_case_2():
    ...
    print("\nRunning tests on edge case 2 for weather app.")
    print("total lines in method: ", len(new_list))
    smd =  SmaliMethodDef.SmaliMethodDef(new_list, None)
    print("size of the type map: ", len(smd.tsc.method_type_list))
    print("Looks like it didnt crash!, congragulations!!!")
...
def type_safety_checker_control_flow_return_statement_test():
    ...
    print("\nRunning tests on leaks app to find proper condition followed by if.")
    print("total lines in method: ", len(new_list))
    smd =  SmaliMethodDef.SmaliMethodDef(new_list, None)
    print("size of the type map: ", len(smd.tsc.method_type_list))
    print("Looks like it didnt crash!, congragulations!!!")
...
def main():
    ...
    # type_safety_checker_control_flow_test_edge_case()
    # type_safety_checker_control_flow_test_edge_case_2()
    # type_safety_checker_control_flow_return_statement_test()
